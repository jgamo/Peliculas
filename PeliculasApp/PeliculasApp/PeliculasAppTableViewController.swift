...
class PeliculasAppTableViewController: UITableViewController {
    ...
    private func llenarDatos(){
        ...
        let imagen2 = UIImage(named: "pokemon_2000")
        let imagen3 = UIImage(named: "coco_poster")
        
        guard let pelicula1 = Pelicula(nombre: "X-Men", compania:"Sony", foto:imagen1, rating:4) else {
            fatalError("Error al crear el objeto")
        }
        
        guard let pelicula2 = Pelicula(nombre: "Pokemon 2000", compania:"The Pokemon Company", foto:imagen2, rating:3) else {
            fatalError("Error al crear el objeto")
        }
        
        guard let pelicula3 = Pelicula(nombre: "Coco", compania:"Walt Disney Pictures", foto:imagen3, rating:4) else {
            fatalError("Error al crear el objeto")
        }
